...
SDL3.Render.Vertex vertices_four[4];
SDL3.Render.Vertex vertices_three[3];

public int main (string[] args) {
    SDL3.Init.set_app_metadata ("SDL3 Vala Renderer Example 10 - Geometry", "1.0",
    ...
    success = SDL3.Render.create_window_and_renderer ("SDL3 Vala Renderer Example 10 - Geometry",
    ...
    while (is_running) {
        ...
        SDL3.Render.render_clear (renderer);
        {
            ...
            SDL3.Render.render_geometry (renderer, null, vertices_three, null);
            ...
            SDL3.Render.render_geometry (renderer, texture, vertices_three, null);
            ...
            SDL3.Render.render_geometry (renderer, texture, vertices_four, indices);
        }
...
void clear_vertex_data (SDL3.Render.Vertex[] vertices) {
